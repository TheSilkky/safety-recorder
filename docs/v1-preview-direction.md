...
capabilities. The current static service token authorizes only the narrow core
preflight/commit route set and must be kept out of logs, metrics labels, public
issues, and support artifacts.
