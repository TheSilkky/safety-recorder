...
| [Private admin web scope](private-admin-web-scope.md) | Current private `/admin` interface scope, visual direction, sensitive-data display rules, non-goals, and validation expectations. |
