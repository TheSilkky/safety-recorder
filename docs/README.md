...
| [Regional stream ingress relay](regional-stream-ingress-relay.md) | Current health/readiness route, backend-issued upload capabilities, relay complete-chunk upload route, temporary ciphertext staging, service-authenticated core preflight/commit forwarding, and remaining boundary for optional relay hardening. |
