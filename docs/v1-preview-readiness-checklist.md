...
| Encrypted location and context | GPS/location/context behavior is encrypted or minimized according to the accepted design. Full GPS, private notes, route history, and safety state are not exposed in server, edge, log, issue, or public viewer metadata by accident. | [v1 preview direction](v1-preview-direction.md), [security model](security-model.md) | [#231](https://github.com/open-proofline/server/issues/231) |
