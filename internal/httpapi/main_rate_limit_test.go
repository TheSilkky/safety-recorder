...
func TestMainAPIRateLimitGroupsRoutesWithSafeKeys(t *testing.T) {
	...
	routes := []struct {
		...
		{http.MethodPost, "/v1/account/second-factor/webauthn/register/start", ":auth_email_verify:", 23},
		{http.MethodPost, "/v1/account/second-factor/webauthn/register/finish", ":auth_email_verify:", 23},
		{http.MethodPost, "/v1/account/second-factor/webauthn/verify/start", ":auth_email_verify:", 23},
		{http.MethodPost, "/v1/account/second-factor/webauthn/verify/finish", ":auth_email_verify:", 23},
		...
		{http.MethodPost, "/v1/relay/fanout-authorize", ":stream:", 18},
