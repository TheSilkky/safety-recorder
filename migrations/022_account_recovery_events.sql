CREATE TABLE IF NOT EXISTS account_recovery_events (
  ...
  email_factors_removed INTEGER NOT NULL DEFAULT 0 CHECK (email_factors_removed >= 0),
  totp_factors_removed INTEGER NOT NULL DEFAULT 0 CHECK (totp_factors_removed >= 0),
  webauthn_credentials_removed INTEGER NOT NULL DEFAULT 0 CHECK (webauthn_credentials_removed >= 0),
